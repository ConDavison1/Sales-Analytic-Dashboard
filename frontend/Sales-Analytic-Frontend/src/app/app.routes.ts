...
export const appRoutes: Routes = [
  ...
  { path: 'revenue-page', component: RevenuePageFullComponent, canActivate: [AuthGuard] },  
  { path: 'clients-page', component: ClientsPageComponent, canActivate: [AuthGuard] },  
  { path: 'signings', component: SigningsPageComponent, canActivate: [AuthGuard] },
  { path: 'pipeline', component: PipelinePageComponent, canActivate: [AuthGuard] }, 
];
