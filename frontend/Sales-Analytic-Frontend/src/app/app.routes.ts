...
import { AccountExecDashboardComponent } from './account-exec-page/account-exec-dashboard/account-exec-dashboard.component';
...
export const appRoutes: Routes = [
  ...
  },
  {
    ...
    component: AccountExecDashboardComponent,
  },
];
